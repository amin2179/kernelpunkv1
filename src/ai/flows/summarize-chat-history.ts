...
/**
 * @fileOverview Summarizes a chat history to quickly recall the main points of a conversation.
 *
...
const prompt = ai.definePrompt({
  ...
  Given the following chat history, provide a concise summary of the main points:
